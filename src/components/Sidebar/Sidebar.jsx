...
const Sidebar = () =>{
    return( 
        <div className='pt-32'>
            ...
            <Link to="https://twitter.com/Akansha_1213" target='blank'><img src={twitterIcon} alt='github' className='py-4 px-4'/></Link>
            <Link to="akanshabharti1213@gmail.com" target='blank'><img src={gmailIcon} alt='github' className='py-4 px-4'/></Link>
