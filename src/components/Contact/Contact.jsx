...
<div className="flex items-center justify-center mt-20  ">
  <form className="text-white ">
    <div className="mb-4 flex flex-row">
      <label className="text-2xl mr-2 ">Full Name:</label>
      <input type="text" className="bg-purple-700 bg-opacity-75  p-2 text-white w-full" />
    </div>
    <div className="mb-4 flex flex-row">
      <label className="text-2xl mr-2">Contact No:</label>
      <input type="text" className="bg-purple-700 bg-opacity-75  p-2 text-white w-full" />
    ...
    <div className="mb-4 flex flex-row">
      <label className="text-2xl mr-2">Message:</label>
      <textarea className="bg-purple-700 bg-opacity-75  p-2 text-white w-full"></textarea>
    </div>
